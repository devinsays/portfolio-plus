			...
			<?php foreach ( $portfolioplus_category_query as $portfolio_cat ) {
				...
				<article class="hentry">
					<div class="entry-content">
						<a href="<?php echo esc_url( $portfolio_cat['term_link'] ); ?>" rel="bookmark" class="thumb" aria-labelledby="post-<?php the_ID(); ?>-title">
							<h3 id="post-<?php the_ID(); ?>-title"><?php echo esc_html( $portfolio_cat['name'] ); ?></h3>
